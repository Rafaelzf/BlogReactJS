        ...
        try{
            ...
            await firebase.login(email, password).catch((error) =>{
                if(error.code === 'auth/user-not-found'){
                    ...
                    alert('Aconteceu o erro: ' + error.code);
                    return null;
                };
            });
        ...
        return(
           <form onSubmit={this.entrar} id="login">
               ...
               <input type="email" autoComplete="off" autoFocus value={this.state.email}
                onChange={(e) =>this.setState({email: e.target.value})} placeholder="teste.teste@gmail.com"/>
                <br />
               ...
               <input type="password" autoComplete="off" value={this.state.password}
                ...
                <Link to="/register">Ainda não possuí uma conta?</Link>
           </form>
        )
    };
}
